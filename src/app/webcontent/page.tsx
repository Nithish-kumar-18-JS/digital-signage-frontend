...
export default function WebContents() {
    ...
    useEffect(() => {
        const fetchMedia = async () => {
            ...
            const data = await getAllMedia(token, "HTML")
    ...
    return (
        <div className="p-4">
            <header className="mb-6">
                <h1 className="text-2xl font-bold">WebContent Library</h1>
            </header>
            {/* search */}
            <div className="flex items-center gap-2">
                ...
                <AddMediaModal title="Add WebContent" description="Add a new WebContent to the library">
