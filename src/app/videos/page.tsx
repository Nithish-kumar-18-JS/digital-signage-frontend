...
export default function Videos() {
    ...
    useEffect(() => {
        const fetchMedia = async () => {
            ...
            const data = await getAllMedia(token, "VIDEO")
    ...
    return (
        <div className="p-4">
            <header className="mb-6">
                <h1 className="text-2xl font-bold">Videos Library</h1>
            </header>
            {/* search */}
            <div className="flex items-center gap-2">
                ...
                <AddMediaModal title="Add Video" description="Add a new video to the library">
